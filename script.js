...
function Create_About_Window() {
    let a_window = Create_A_Window("100px", "100px", "About", "250px", "250px");
    ...
    content.innerText="Love life. Into programming. Proficient .NET C# developer. Wanting to become cloud engineer.";
...
function Create_A_Window(x, y, title, w, h) {
    ...
    a_window.id="window" + windowIndex;
    ...
    a_window_close.style.color="white";
